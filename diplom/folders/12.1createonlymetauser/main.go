...
const thisServiceName httpservice.ServiceName = "folders.createonlymetauser"
...
func main() {
	httpservice.InitNewService(thisServiceName, false, 50, &config{}, authGetServiceName, tokenDecoderServiceName)
}
